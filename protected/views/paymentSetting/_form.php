...
?>
	...
	<?php echo $form->errorSummary($model); ?>
	 ...
	 <?php //echo $form->textFieldGroup($model,'mode',array('class'=>'form-control')); ?>
	 
	 <?php //echo $form->dropDownListGroup($model,'mode', array('widgetOptions'=>array('data'=>$model->getModeOptions(), 'htmlOptions'=>array('class'=>'input-large','prompt'=>'--- SELECT ---')))); ?>	
