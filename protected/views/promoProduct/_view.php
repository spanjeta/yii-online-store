<div class="view">
	...
	<br />
	<?php echo Html::encode($data->getAttributeLabel('cart_id')); ?>:
		<?php echo Html::encode(Html::valueEx($data->cart)); ?>
	<br />
	<?php echo Html::encode($data->getAttributeLabel('promo_id')); ?>:
		<?php echo Html::encode(Html::valueEx($data->promo)); ?>
	<br />
