		...
		<div class="container">
			...
			?>
					...
					?>       
					   ...
					   <?php
					        ...
					        <li data-target='#carousel-custom'
								...
								class='active' <?php }?>><img src='<?php echo $prodimage->getProImage();?>' alt='' /></li>
				...
				<div class="p-right-column col-lg-7 col-md-7 product-description">
					...
					if(empty($wishlist)){?>
					<a href="#" onclick="addWishList(<?php echo $model->id;?>)" class="cart-wishlist form-control"><i class="fa fa-heart-o"></i> Add to wishlist</a>
					<?php }else {?>
					<a href="#" onclick="addWishList(<?php echo $model->id;?>)" class="cart-wishlist form-control"><i class="fa fa-heart"></i> Remove from wishlist</a>
					<?php } ?>
...
$wishlist = WishList::getWishList ( $product->id, Yii::app ()->user->id );
				if (empty ( $wishlist )) {
					?>
					<a href="#" onclick="addWishList(<?php echo $product->id;?>)"><i
