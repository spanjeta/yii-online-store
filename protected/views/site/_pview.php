...
<!-- Product of a shop come on this place -->
<?php if($products)  { 
...
<div class="hentry thumb">
	...
	<div class="brick-header">
		<div class="thumb-holder">
			...
			?>
				<?php //$onsale = $product->onsale();  if($onsale) {?>
			...
			<a class="featured-thumb-link"  href="<?php echo Yii::app()->createUrl('product/info',array('id'=>$product->id));?>"> <img class="featured-thumb"
