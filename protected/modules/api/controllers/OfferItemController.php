...
class OfferItemController extends GxController {
	...
	{
		$model = $this->loadModel($id, 'OfferItem');
	...
	public function actionCreate()
	{
		...
		$this->performAjaxValidation($model, 'offer-item-form');

		if (isset($_POST['OfferItem'])) {
			$model->setAttributes($_POST['OfferItem']);
	...
	public function actionDelete($id)
	{
		...
		if (Yii::app()->getRequest()->getIsPostRequest()) {
			$this->loadModel($id, 'OfferItem')->delete();
	...
	public function actionIndex()
	{
		...
		$dataProvider = new CActiveDataProvider('OfferItem');
	...
	public function actionSearch()
	{
		...
		if (isset($_GET['OfferItem']))
		{
			$model->setAttributes($_GET['OfferItem']);
	...
	protected function updateMenuItems($model = null)
	{
		...
		if ( $model == null ) $model = new OfferItem();
