...
echo '';
		...
		if ($code == 1)
			echo $form->html5EditorGroup ( $model, 'queue', array (
					'class' => 'form-control',
					'rows' => 5,
					'height' => '200',
					'options' => array (
			...
			echo $form->redactorGroup ( $model, 'queue', array (
					'class' => 'form-control',
					'id' => 'queue_redactor',
					'rows' => 5 
			) );
			...
			echo $form->ckEditorGroup ( $model, 'queue', array (
					'options' => array (
							'fullpage' => 'js:true',
							'width' => '640',
							'resize_maxWidth' => '640',
			...
			echo $form->textAreaGroup ( $model, 'queue', array (
					'class' => 'form-control',
					'rows' => 5 
			) );
		;
...
echo '';
		...
		if ($code == 1)
			echo $form->html5EditorGroup ( $model, 'sent', array (
					'class' => 'form-control',
					'rows' => 5,
					'height' => '200',
					'options' => array (
			...
			echo $form->redactorGroup ( $model, 'sent', array (
					'class' => 'form-control',
					'id' => 'sent_redactor',
					'rows' => 5 
			) );
			...
			echo $form->ckEditorGroup ( $model, 'sent', array (
					'options' => array (
							'fullpage' => 'js:true',
							'width' => '640',
							'resize_maxWidth' => '640',
			...
			echo $form->textAreaGroup ( $model, 'sent', array (
					'class' => 'form-control',
					'rows' => 5 
			) );
		;
...
/* echo $form->datepickerGroup ( $model, 'finishedOn', array (
				'widgetOptions' => array (
						'options' => array (
								'format' => 'yyyy-mm-dd',
								'autoclose' => true 
...
$this->widget ( 'booster.widgets.TbButton', array (
				...
				'htmlOptions' => array (
						'class' => 'btn btn-success col-sm-4 pull-right' 
				) 
		) );
		?>
	</div>
