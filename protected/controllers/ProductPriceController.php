...
class ProductPriceController extends Controller {
	...
	public function actionView($id) {
		$model = $this->loadModel ( $id, 'ProductPrice' );
	...
	public function actionCreate() {
		...
		$this->performAjaxValidation ( $model, 'product-price-form' );
		
		if (isset ( $_POST ['ProductPrice'] )) {
			$model->setAttributes ( $_POST ['ProductPrice'] );
	...
	public function actionDelete($id) {
		...
		if (Yii::app ()->getRequest ()->getIsPostRequest ()) {
			$this->loadModel ( $id, 'ProductPrice' )->delete ();
	...
	public function actionSearch() {
		...
		if (isset ( $_GET ['ProductPrice'] )) {
			$model->setAttributes ( $_GET ['ProductPrice'] );
