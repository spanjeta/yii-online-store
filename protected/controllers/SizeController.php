...
class SizeController extends Controller {
	...
	public function actionMap() {
		$data = 'http://maps.googleapis.com/maps/api/geocode/json?address=chandigarh&sensor=true';
	}
	public function actionAjaxsize() {
		if (isset ( $_GET ['q'] )) {
			$cts = Size::model ()->findAll ();
			$data = array ();
