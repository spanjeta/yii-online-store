 ...
 */
abstract class BaseSize extends ActiveRecord {
	...
	protected function beforeDelete()
	{
		...
		VarProduct::model()->deleteAllByAttributes(array('size_id'=>$this->id));
	...
	public function rules() {
		return array(
			...
			array('type_id, state_id', 'default', 'setOnEmpty' => true, 'value' => null),
			array('id, title, description, type_id, state_id, create_user_id, create_time, update_time', 'safe', 'on'=>'search'),
		);
	}
