 ...
 */
abstract class BaseAuthSession extends ActiveRecord {
	...
	public function rules() {
		return array(
			array('auth_code, device_token, create_user_id, create_time, update_time', 'required'),
			array('type_id, create_user_id', 'numerical', 'integerOnly'=>true),
			array('auth_code, device_token', 'length', 'max'=>256),
